  ...
  var require_ui = __commonJS({
    "src/ui.ts"(exports) {
      document.addEventListener("DOMContentLoaded", () => {
        ...
        form.addEventListener("submit", (event) => __async(exports, null, function* () {
          ...
          try {
            ...
            const payload = yield loadPdsaPayload(details);
      ...
      function loadPdsaPayload(details) {
        return __async(this, null, function* () {
          var _a, _b;
          const pds = yield fetchJsonFile(details, "pds.json", true);
          ...
          for (const flow of (_a = pds.product.flows) != null ? _a : []) {
            const definition = yield fetchJsonFile(details, flow.file);
          ...
          const designSystem = yield fetchJsonFile(details, designSystemPath);
          return {
            repo: details,
            pds,
            flows,
      ...
      function fetchJsonFile(details, relativePath, allowMarkdownFallback = false) {
        return __async(this, null, function* () {
          const normalizedPath = joinPath(details.basePath, relativePath);
          try {
            return yield fetchGitHubJson(details, normalizedPath);
          } catch (error) {
            if (allowMarkdownFallback && normalizedPath.endsWith(".json")) {
              const markdownPath = normalizedPath.replace(/\.json$/i, ".md");
              return yield fetchGitHubJson(details, markdownPath);
            }
            throw error;
          }
        });
      }
      function fetchGitHubJson(details, path) {
        return __async(this, null, function* () {
